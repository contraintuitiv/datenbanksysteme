# C1:
- Berechnen Sie die Anzahl der Verbrechen pro Tag für die Zeit von Januar 2001 bis August 2024.
...
# C2:
- Finden Sie die Top-5-Verbrechensorte (block) mit dem höchsten Prozentsatz an Verhaftungen (arrest).
...
# C3:
- Finden Sie den Wochentag und die Stunde (z. B.: Montag um 15 Uhr), an denen die meisten Verbrechen
